...
const mongooseUrl = "mongodb+srv://Thinasharma45:Thina9677@blog.pkvb0ss.mongodb.net/blogdb";
...
app.get("/posts/:id",(req,res)=>{
  ...
  const requiredPost = posts[searchIndex];
...
app.patch("/posts/:id",(req,res)=>{
  const id = parseInt(req.params.id);
  var existingPost = posts.find((post)=>{
    return post.id===id;
  });
  const updatedPost ={
    id:id,
  ...
  posts[id].title=updatedPost.til=title;
  posts[id].date=updatedPost.date;
  console.log(posts);
